...
public class BlockHandler {
    ...
    public Block createBlock(PublicKey myAddress) {
        ...
        //4) takes as much transactions as possible from TRANSACTION POOL
        ...
        current.finalize();
        //5) finally, add the block to the block chain
