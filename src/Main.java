...
public class Main {
   ...
   public static void main(String[] args) throws NoSuchProviderException, NoSuchAlgorithmException, InvalidKeyException, SignatureException {
	...
	block1.finalize();
	System.out.println("Block1 Added ok: " + bh.processBlock(block1) + block1.getHash());
	System.out.println("Prev: "+block1.getPrevBlockHash());
	/*
	...
	System.out.println("Block2 Added ok: " + bh.processBlock(block2)+ block2.getHash());
	System.out.println("Prev: "+block2.getPrevBlockHash());
	/*
	...
	System.out.println("Block3 Added ok: " + bh.processBlock(block3)+block3.getHash());
	System.out.println("Prev: "+block3.getPrevBlockHash());
	/*
	...
	System.out.println("Block4 Added ok: " + bh.processBlock(block4)+block4.getHash());
	System.out.println("Prev: "+block4.getPrevBlockHash());
	/*
	...
	System.out.println("Prev: "+block5.getPrevBlockHash());
    }
